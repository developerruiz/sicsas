...
var proTabs ={
    ...
    primer_contenido: document.getElementById('contenedor_procesos').firstElementChild,
    ...
    divs_contenido: document.querySelectorAll('#contenedor_procesos > div'),
...
var metTabs ={
    ...
    evento:function(e) {
        ...
        for (let i = 0; i < proTabs.divs_contenido.length; i++) {
